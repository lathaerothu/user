...
public class UserdetailsService {
	...
	public Map<String, Object> updateUserdetails(Userdetailsbeanclass user_pojo) {
		...
		try {
			...
			SqlParameterSource response = new MapSqlParameterSource().addValue("Uname", name).addValue("Uid", id);
			int result = namedParameterJdbcTemplate.update(query, response);
	...
	public Map<String, Object> deleteUserdetails(int id) {
		Map<String, Object> Mapresponse = new HashMap<>();
	...
	public List<Map<String, Object>> selectUserdetails(int id) {
