...
public class UserdetailsController {
	...
	public Map<String, Object> deleteUserdetails(@RequestParam int accountid) {
		return user_service.deleteUserdetails(accountid);
	}
	@GetMapping("/user/{accountid}")//    /10
	public List<Map<String,Object>> selectUserdetails(@PathVariable int accountid) {
		return user_service.selectUserdetails(accountid);
	}
/*	@GetMapping("/user")
